...
public class InvestigationContactRecordTest extends TestBase {
	...
	@Test(priority = 8, description = "S:0190 Investigation Contact Records using investigation User", groups = {
	...
	@Test(priority = 1, description = "S:0111 Investigation Contact Records using Supervisor User", groups = { "High",
	...
	public void InvestigationCaseRecordSupervisor() throws AcisException, InterruptedException {
		try {
			...
			// Pre-requisite forinvestigation flow completed
			personsInformationPage.clickRelatedTab();
			investigationCasePage.openAlligationRecord();
	...
	@Test(priority = 2, description = "S:0111 Investigation Contact Records using Supervisor User", groups = { "High",
			"ACIS_Regression", "Khushboo" })
	...
	@Test(priority = 3, description = "S:0111 Investigation Contact Records using Supervisor User", groups = { "High",
			"ACIS_Regression", "Khushboo" })
	...
	@Test(priority = 4, description = "S:0111 Investigation Contact Records using Supervisor User", groups = { "High",
			"ACIS_Regression", "Khushboo" })
	...
	@Test(priority = 7, description = "S:0111 Assessments Contact Records using Supervisor User", groups = { "High",
			"ACIS_Regression", "Khushboo" })
	...
	@Test(priority = 5, description = "S:0111 Assessments Contact Records using Intake User", groups = { "High",
			"ACIS_Regression", "Khushboo" })
	...
	@Test(priority = 6, description = "S:0111 Assessments Contact Records using Investigator User", groups = { "High",
			"ACIS_Regression", "Khushboo" })
	...
	@Test(priority = 7, description = "S:0111 Assessments Contact Records using Admin User", groups = { "High",
			"ACIS_Regression", "Khushboo" })
