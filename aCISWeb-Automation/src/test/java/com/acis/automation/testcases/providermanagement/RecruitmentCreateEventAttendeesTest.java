...
public class RecruitmentCreateEventAttendeesTest extends TestBase{
	...
	@Test(enabled=false, description = "US:0777 Provider Management - New Orientation Event page verification", groups = {
	...
	@Test(enabled=false, description = "US:0777 Provider Management - Search for interested person by first name , last name , Phone and email", groups = {
	...
	"High", "acisRegression", "Pallavi" }, priority = 2)
		public void updateExistingFosterParentForm() throws AcisException {
			try {
				...
				homePage_SFDCPage.clickDownArrowEvent();
				homePage_SFDCPage.selectAllEvent();
				newRecruitmentEventPage.searchGlobalEvent("E-00000035");
