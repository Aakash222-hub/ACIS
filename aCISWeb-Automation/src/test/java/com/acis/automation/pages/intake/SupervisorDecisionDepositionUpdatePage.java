...
public class SupervisorDecisionDepositionUpdatePage extends PageBase {
	...
	final static Log logger = LogFactory.getLog(SupervisorDecisionDepositionUpdatePage.class);
	...
	@FindBy(xpath="//th//span//a[contains(@title,'N-')]")
	...
	public void selectingAcceptingAssign(String screeningDecissionStatus, String workerDecission) throws AcisException {
		...
		try {
			...
			logger.info("Verified Supervisor Screening Decission Label and Worker Decission label and selected Accept&Assign");
		} catch (AcisException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
 ...
 * This method is selecting Intake and coming to Screendecisson page 
 * @throws AcisException 
 */
		 ...
		 * @author akash.a.gaurav
		 */
		public void verifyingSuperVisorOverride(String disposition,String supervisorReommendation, String workerScreening) {
			try {
				logger.info("Verifying the status of Supervisor Overide with disposition selected as Screen In For Investigation");
 ...
 */
		...
		public void narrativeReporterDetailPage(String strNarrative) throws AcisException, UnsupportedFlavorException, IOException {
      ...
      // String narrative=act.keyDown(Keys.CONTROL).sendKeys(String.valueOf('\u0063')).keyUp(Keys.CONTROL).perform();
 ...
 */
		...
		public void narrativeLink() throws AcisException {
			...
			scrollingToElementofAPage(narrativeReporter);
			logger.info("Clicking on Narrative link");
		   clickWebElemntUsingJavascriptExecutor(narrativeReporter);
