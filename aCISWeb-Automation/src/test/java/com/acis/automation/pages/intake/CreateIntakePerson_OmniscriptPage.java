...
public class CreateIntakePerson_OmniscriptPage extends PageBase {
	...
	@FindBy(xpath = "(//vlocity_ps-omniscript-date[@data-omni-key='Birthdate']//*[contains(text(),'Date of Birth')]/../..//input)[last()]")
	...
	@FindBy(xpath = "//button[@title='Close Create Intake Person']")
	WebElement closeButton;
	
	@FindBy(xpath = "//h1[normalize-space()='Person(s) Involved']")
	WebElement searchPersonVerify;
	
	@FindBy(xpath = "//*[@data-omni-key='NameInfoFormula']")
	WebElement nameInformationVerify;
	
	@FindBy(xpath = "//span[text()='Role']/../../..//input")
	WebElement role;

	@FindBy(xpath = "//span[text()='Role']/../../..//div[@data-value='Alleged Victim']")
	WebElement roleAllegedVictim;
	
	@FindBy(xpath = "//span[text()='Role']/../../..//div[@data-value='Alleged Maltreator']")
