...
public class Interview_OmniScriptPage extends PageBase{
	...
	WebElement closeInterviewMessage;

	@FindBy(xpath = "//h1[text()='Collateral Contacts']")
	...
	@FindBy(xpath="//h1[contains(text(),'Collateral')]")
	WebElement collateralTitle ;
	...
	public void clickCreateInterviewLink() throws AcisException {
		waitForElement(createInterviewLink);
	...
	public void closeCaregiverTab() throws AcisException {
		logger.info("Closing Caregiver Tab");
		waitForElement(closeInterviewMessage);
	 ...
	 * @throws AcisException 
	 */
	public void closeCaregiverTabCheck() throws AcisException {
		logger.info("Closing Caregiver Tab");
		switchToDefaultContent();
		clickWebElemntUsingJavascriptExecutor(closeInterviewTabButton);
		waitForPageLoadTill(5);
	...
	public void clickNextButton() throws AcisException {
		...
		waitForPageLoad();
		waitForPageLoadTill(5);
		waitForElement(collateralTitle);
