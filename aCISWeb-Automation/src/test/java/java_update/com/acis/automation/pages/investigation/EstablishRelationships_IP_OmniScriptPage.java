...
public class EstablishRelationships_IP_OmniScriptPage extends PageBase {
	...
	public void searchText(String str, String Option) throws AcisException {
		...
		case "Person":
			...
			waitForElement(driver.findElement(
					By.xpath("(//span[text()='Person']/../../..//span[contains(text(),'" + str + "')])[last()]")));
		...
		case "Related":
			...
			String ui = driver
					.findElement(By.xpath(
							"(//span[text()='Related To']/../../..//span[contains(text(),'" + str + "')])[last()]"))
					.getText().trim();
			System.out.println(ui);
			waitForElement(driver.findElement(
					By.xpath("(//span[text()='Related To']/../../..//span[contains(text(),'" + str + "')])[last()]")));
			clickWebElement(driver.findElement(
					By.xpath("(//span[text()='Related To']/../../..//span[contains(text(),'" + str + "')])[last()]")));
	...
	public void submitSafetyAssesment() throws AcisException, InterruptedException {
