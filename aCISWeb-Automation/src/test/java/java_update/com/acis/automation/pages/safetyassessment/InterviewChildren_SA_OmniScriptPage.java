...
public class InterviewChildren_SA_OmniScriptPage extends PageBase{
	...
	@FindBy(xpath = "//a[contains(text(),'Create Children Interview')]")
	...
	@FindBy(xpath = "//*[@id='ChildInterviews_nextBtn']//*[text()='Save']")
	...
	@FindBy(xpath="//h1[text()='Interview Caregivers']")
	...
	public void provideDate() throws AcisException {
		try {
			...
			clickWebElemntUsingJavascriptExecutor(interviewChildrenDateTime);
			clickWebElement(date);
			logger.info("Enter Date");
		}	
	}
	...
	public void clickSavebutton() throws AcisException {
		...
		logger.info("Successfully Saved Interview ");
	}
