...
public class PopupforAddingPersononPersonSearchStepSafetyAssessmentNewTest extends TestBase {

	final static Logger logger = LoggerFactory
			.getLogger(PopupforAddingPersononPersonSearchStepSafetyAssessmentNewTest.class);

	public PopupforAddingPersononPersonSearchStepSafetyAssessmentNewTest() throws AcisException {
		super();
	...
	@Test(priority = 1, description = "S-0946:Pop-up for Adding Person on Person Search Step (Safety Assessment-Edit) Intake Approval", groups = {
	...
	public void intakeApproval() throws AcisException {
		try {
			...
			// TODO Auto-generated catch block
			getStackTrace(e,
					" Failed S-0946:Pop-up for Adding Person on Person Search Step (Safety Assessment-Edit) Intake Approval");

		}
	}

	@Test(priority = 2, description = "S-0946:Pop-up for Adding Person on Person Search Step (Safety Assessment-Edit) Safety Assessment Investigation", groups = {
			"Medium", "ACIS_Regression", "Khushboo" })
	...
	@Test(priority = 3, description = "S-0946:Pop-up for Adding Person on Person Search Step (Safety Assessment-Edit) Safety Assessment Supervisor", groups = {
			"Medium", "ACIS_Regression", "Khushboo" })
