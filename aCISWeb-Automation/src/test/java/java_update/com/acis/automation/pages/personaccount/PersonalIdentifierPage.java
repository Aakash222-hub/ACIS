...
public class PersonalIdentifierPage extends PageBase {
	...
	@FindBy(xpath = "//*[text()='Identifier Type']/../..//input[@type='text']")
	WebElement identifierType;
	
	@FindBy(xpath = "//*[text()='Identifier Number']/../..//input[@type='text']")
	WebElement identifierNumber;
	
	@FindBy(xpath = "//span[text()='ID Type SSN']")
	WebElement radioSSN;
	
	@FindBy(xpath = "//*[text()='Social Security Number']/../..//input")
	WebElement socialSecurityNumber;
	
	
	@FindBy(xpath = "//*[text()='Issued Date']/../..//input[@type='text']")
	WebElement issuedDatePicker;
	
	@FindBy(xpath = "//span[text()='12']")
	WebElement issuedDate;
	
	@FindBy(xpath = "//*[text()='Expiry Date']/../..//input[@type='text']")
	...
	@FindBy(xpath = "//*[@title='Drivers License']")
	...
	public By  identifierTypeSSN = By.xpath("//*[@title='SSN']");
	
	public By errorSSNFormat = By.xpath("//li[contains(text(),'format') and contains(text(),'SSN')]");
	
	public By driversLicense = By.xpath("//*[@title='Drivers License']");
	
	public By insNumber = By.xpath("//*[@title='INS Number']");
	
	public By medicaid = By.xpath("//*[@title='Medicaid']");
	
	public By medicare = By.xpath("//*[@title='Medicare']");
	
	public By passport = By.xpath("//*[@title='Passport']");
	
	public By military = By.xpath("//*[@title='Military']");
	...
	public void verifyIdentiferTypeNonSSN() throws AcisException, InterruptedException {
		...
		isElementPresent(driversLicense);
