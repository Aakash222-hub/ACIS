...
public class ProviderAgencyAccountPage extends PageBase {
	...
	@FindBy(xpath = "//*[text()='Provider Agency Type']/../..//input")
	WebElement providerAgencyType;

	@FindBy(xpath = "//span[@title='Child Care']")
	WebElement childCare;

	@FindBy(xpath = "//span[@title='Substance Abuse Treatment']")
	WebElement substanceAbuseTreatment;

	@FindBy(xpath = "//span[@title='Transportation']")
	WebElement transportation;

	@FindBy(xpath = "//span[@title='Tutoring']")
	WebElement tutoring;

	@FindBy(xpath = "//*[@title='Licensed Child Placement Agency']")
	...
	@FindBy(xpath = "//input[@name='ACIS_Primary_Address__c']")
	...
	public void setState(String str) throws AcisException {
		...
		waitForElementClickable(driver.findElement(By.xpath("//span[@title='"+str+"']")));
		clickWebElement(driver.findElement(By.xpath("//span[@title='"+str+"']")));
	...
	public void verifySubmittedNotStatusValue() throws AcisException {
		...
		waitForPageLoadTill(6);
		clickWebElemntUsingJavascriptExecutor(status);
