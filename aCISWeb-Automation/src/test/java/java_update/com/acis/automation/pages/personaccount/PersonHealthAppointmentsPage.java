...
public class PersonHealthAppointmentsPage extends PageBase {
	...
	@FindBy(xpath = "//*[text()='Provider Name']/../..//input[@type='text']")
	WebElement providerName;
	
	@FindBy(xpath = "//*[text()='Provider Type']/../..//input[@type='text']")
	WebElement providerType;
	
	@FindBy(xpath = "//*[text()='Provider Contact Information']/../..//input[@type='text']")
	WebElement providerContactInformation;
	
	@FindBy(xpath = "//*[text()='Date Last Seen']/../..//input[@type='text']")
	WebElement dateLastSeen;
	
	@FindBy(xpath = "//*[text()='Date of Next Visit']/../..//input[@type='text']")
