...
public class ReviewAllegationReport_SA_OmniScriptPage extends PageBase{
	...
	@FindBy(xpath = "//button[@title='click here']")
	WebElement linkCreateNewPerson;
	
	@FindBy(xpath = "//*[text()='The Case Person details are saved. Close this modal to return to the New Person Flow.']")
	WebElement personCreated;
	...
	@FindBy(xpath = "(//table//tbody//tr//td//a[contains(text(),'I-')])[last()]")
	 ...
	 * @throws InterruptedException 
	 */
	public void verifyPersonCreated() throws AcisException, InterruptedException {
		System.out.println("Verifying Person Created");
		waitForElement(personCreated);
		logger.info("Verified Person Created");
		waitForPageLoadTill(5);
	}
	...
	public void clickNextButton() throws AcisException, InterruptedException {
		...
		logger.info("User is on the Person InvvoledPage");
