...
public class NewRecruitmentEventPage extends PageBase{
	...
	@FindBy(xpath = "//*[text()='Person(s) Involved']")
    WebElement 	personsInvolvedTitle;
	
	@FindBy(xpath="//tbody/tr[1]/td[1]/label/span[1]")
	WebElement selectCheckBox;
	
	@FindBy(xpath="//*[text()='Add Prospect']")
	WebElement addProspect;
	
	@FindBy(xpath="//span[text()='Prospective Foster Parents']/../../../../../..//*[text()='New']")
	...
	@FindBy(xpath="(//*[text()='First Name'])[last()]//..//..//..//input")
	WebElement textFirstName;
	
	@FindBy(xpath="(//*[text()='Last Name'])[last()]//..//..//..//input")
	WebElement textLastName;
	
	@FindBy(xpath="(//*[text()='Email'])[last()]//..//..//..//input")
	WebElement textEmail;
	
	@FindBy(xpath="(//*[text()='Phone'])[last()]//..//..//..//input")
	...
	WebElement closeProspectiveFosterCare;

	public By state = By.xpath("//span[text()='State/Territory']/../../..//input");
	...
	//	scrollingToElementofAPage(linkCreateNewProspect);
	...
	//	clickWebElemntUsingJavascriptExecutor(stateTerritory);
		clickWebElement(stateTerritory);
		Actions act = new Actions(driver);
		waitForElement(stateAR);
		act.moveToElement(stateAR).click().perform();
	//	waitForElement(stateAR);
//		clickWebElement(stateAR);
	...
	public String getProspectiveID() throws AcisException {
		...
		waitForPageLoadTill(5);
		//clickWebElement(detailsTab);
		scrollingToElementofAPage(prospectiveFosterParentId);
	...
	public void searchGlobalEvent(String strText) throws AcisException, InterruptedException {
		...
		clickWebElemntUsingJavascriptExecutor(eventRecord);
	...
	/*** Set First Name, Last name,Phone and email
	 * @author khushboo
	 * @throws AcisException 
	 */
	public void setFields(String option, String str) throws AcisException {
		switch(option) {
		case "First Name":
			logger.info("Enter the First Name");
			waitForElement(textFirstName);
			clickWebElemntUsingJavascriptExecutor(textFirstName);
			//clickWebElement(street1);
			enterText(textFirstName, str);
			logger.info("Entered the first Name");
			break;
			
		case "Last Name":
			logger.info("Enter the last name");
			clickWebElemntUsingJavascriptExecutor(textLastName);
			enterText(textLastName,str);
			break;
			
		case "Email":
			logger.info("Enter the email");
			waitForElement(textEmail);
			clickWebElemntUsingJavascriptExecutor(textEmail);
			enterText(textEmail, str);
			break;
		case"Phone":
			logger.info("Enter the phone");
			waitForElement(textPhone);
			//clickWebElemntUsingJavascriptExecutor(textPhone);
			//Actions actions=new Actions(driver);
			//actions.sendKeys(Keys.TAB).build().perform();
			//actions.sendKeys(Keys.ENTER).build().perform();
			enterText(textPhone, str);
			break;
		
		default:
			logger.info("field: " + option + " not found");
			break;
		}
	}
...
/*close prospective foster care
 * @khushboo
 * 
 * 
 */
	public void closeFosterCareProspective() throws AcisException {
		logger.info("closing tab");
		waitForElement(closeProspectiveFosterCare);
		clickWebElement(closeProspectiveFosterCare);
