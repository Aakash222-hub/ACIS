...
public class NewPlacement_OmniScriptPage extends PageBase {
	...
	@FindBy(xpath = "//input[@name='SpecialNeeds1']/..//*[text()='Medically Complex']/preceding-sibling::span")
	WebElement sn_MedicallyComplexCheckboxPlan;

	@FindBy(xpath = "//input[@name='SpecialNeeds1']/..//*[text()='Teen Parent']/preceding-sibling::span")
	WebElement sn_TeenParentCheckboxPlan;

	@FindBy(xpath = "//input[@name='SpecialNeeds1']/..//*[text()='Disabled']/preceding-sibling::span")
	WebElement sn_DisabledCheckboxPlan;

	@FindBy(xpath = "//input[@name='SpecialNeeds1']/..//*[text()='LGBTQ']/preceding-sibling::span")
	WebElement sn_LGBTQCheckboxPlan;

	@FindBy(xpath = "//input[@name='SpecialNeeds1']/..//*[text()='SEN']/preceding-sibling::span")
	WebElement sn_SENCheckboxPlan;

	@FindBy(xpath = "//input[@name='SpecialNeeds1']/..//*[text()='ESL']/preceding-sibling::span")
	WebElement sn_ESLCheckboxPlan;
	...
	@FindBy(xpath = "//h1[text()='Create Placement']")
	 ...
	 * @throws AcisException
	 */
	public void selectSpecialNeedsPlan(String option) throws AcisException {
		waitForElement(sn_MedicallyComplexCheckboxPlan);
		scrollingToElementofAPage(sn_MedicallyComplexCheckboxPlan);
		switch (option) {
		case "Medically Complex":
			logger.info("Selecting Speical need : " + option);
			clickWebElemntUsingJavascriptExecutor(sn_MedicallyComplexCheckboxPlan);
			logger.info("Selected Speical need : " + option);
		...
		case "Teen Parent":
			logger.info("Selecting Speical need : " + option);
			clickWebElemntUsingJavascriptExecutor(sn_TeenParentCheckboxPlan);
			logger.info("Selected Speical need : " + option);
		...
		case "Disabled":
			logger.info("Selecting Speical need : " + option);
			clickWebElemntUsingJavascriptExecutor(sn_DisabledCheckboxPlan);
			logger.info("Selected Speical need : " + option);
		...
		case "LGBTQ":
			logger.info("Selecting Speical need : " + option);
			clickWebElemntUsingJavascriptExecutor(sn_LGBTQCheckboxPlan);
			logger.info("Selected Speical need : " + option);
		...
		case "SEN":
			logger.info("Selecting Speical need : " + option);
			clickWebElemntUsingJavascriptExecutor(sn_SENCheckboxPlan);
			logger.info("Selected Speical need : " + option);
		...
		case "ESL":
			logger.info("Selecting Speical need : " + option);
			clickWebElemntUsingJavascriptExecutor(sn_ESLCheckboxPlan);
			logger.info("Selected Speical need : " + option);
