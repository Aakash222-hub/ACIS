...
import com.acis.automation.pages.Placement.PlacementPersonAccountPage;
...
import com.acis.automation.pages.caseplan.DecisionPage;
import com.acis.automation.pages.caseplan.FamilyPlacebookPage;
import com.acis.automation.pages.caseplan.NewInteractionVisitsPage;
...
import com.acis.automation.pages.locaterelatives.CreatePlacementResourcePage;
import com.acis.automation.pages.locaterelatives.EstablishRelationshipsPage;
import com.acis.automation.pages.locaterelatives.LocateRelativesPage;
import com.acis.automation.pages.locaterelatives.PersonsInvovledPage;
...
import com.acis.automation.pages.personaccount.InsightsPage;
import com.acis.automation.pages.personaccount.PersonMedicationPage;
import com.acis.automation.pages.personaccount.PersonRelationshipPage;
...
import com.acis.automation.pages.personaccount.SpecialNeedsPage;
...
import com.acis.automation.pages.safetyassessment.PersonsInvolved_SA_OmniscriptPage;
import com.acis.automation.pages.safetyassessment.ReviewAllegationReport_SA_OmniScriptPage;
import com.acis.automation.pages.safetyassessment.SafetyAssessmentPage;
...
public class TestBase {
	...
	public static PersonRelationshipPage personRelationshipPage;

	public static PermanencyPlanPage permanencyPlanPage;
	public static DecisionPage decisionPage;
	...
	public static PersonsInvolved_SA_OmniscriptPage personsInvolved_SA_OmniscriptPage;
	...
	public static PersonsInvovled_Workflow_OmniscriptPage personsInvovled_Workflow_OmniscriptPage;
	...
	public static PersonsInvovled_IP_OmniscriptPage personsInvovled_IP_OmniscriptPage;
	...
	// person account health tab 
	public static SpecialNeedsPage specialNeedsPage;
	public static PlacementPersonAccountPage placementPersonAccountPage;
	
	//New Interactions
	public static NewInteractionVisitsPage newInteractionVisitsPage;
	
	public static SafetyAssessmentPage safetyAssessmentPage;
	
	//locate Relatives/Kin
	public static CreatePlacementResourcePage createPlacementResourcePage;
	public static EstablishRelationshipsPage establishRelationshipsPage;
	public static LocateRelativesPage locateRelativesPage;
	public static PersonsInvovledPage personsInvovledPage;
	...
	public void initializePageObjects() throws AcisException {
		...
		personRelationshipPage= new PersonRelationshipPage(); 
		...
		personsInvolved_SA_OmniscriptPage = new PersonsInvolved_SA_OmniscriptPage();
		...
		personsInvovled_IP_OmniscriptPage = new PersonsInvovled_IP_OmniscriptPage();
		personsInvovled_Workflow_OmniscriptPage = new PersonsInvovled_Workflow_OmniscriptPage();
		...
		placementPersonAccountPage = new PlacementPersonAccountPage();
		...
		newInteractionVisitsPage=new NewInteractionVisitsPage();
		// Accounts
		...
		safetyAssessmentPage = new SafetyAssessmentPage();
		
		customButtonVisibilityPage= new CustomButtonVisibilityPage();
		
		specialNeedsPage=new SpecialNeedsPage();
		
		//locate Relatives/Kin
		createPlacementResourcePage = new CreatePlacementResourcePage();
		establishRelationshipsPage = new EstablishRelationshipsPage();
		locateRelativesPage = new LocateRelativesPage();
		personsInvovledPage = new PersonsInvovledPage();
