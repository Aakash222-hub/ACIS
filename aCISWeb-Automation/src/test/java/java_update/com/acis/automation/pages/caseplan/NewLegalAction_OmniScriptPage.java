...
public class NewLegalAction_OmniScriptPage extends PageBase {
	...
	@FindBy(xpath="(//span[contains(normalize-space(),'childFirstName')])[last()]")
	...
	@FindBy(xpath = "//*[text()='New Court Action']")
	...
	public void clickInsightsTab() throws AcisException {
		...
		scrollingToElementofAPage(tabInsight);
...
//		clickWebElement(driver.findElement(By.xpath("(//*[contains(text(),'" + childname + "')])")));
	...
	public void addCourtActionParticipant(String firstName, String middleName, String lastName) throws AcisException{
	
		String childFullName= firstName + " " + middleName + " " +lastName;
		scrollingToElementofAPage(courtActionParticipant);
		waitForElement(courtActionParticipant);
		clickWebElement(courtActionParticipant);
		waitForPageLoadTill(5);
		System.out.println(childFullName);
		waitForPageLoadTill(10);       
		Actions action = new Actions(driver);
		try {
			action.moveToElement(driver.findElement(By.xpath("(//span[contains(text(),'" + firstName +" "+ lastName + "')])"))).click().perform();
				}
		catch (Exception e) {

			action.moveToElement(driver.findElement(By.xpath("(//span[contains(text(),'" + childFullName + "')])"))).click().perform();
