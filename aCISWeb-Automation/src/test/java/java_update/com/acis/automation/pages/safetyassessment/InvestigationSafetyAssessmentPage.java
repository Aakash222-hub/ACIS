...
public class InvestigationSafetyAssessmentPage extends PageBase {
	...
	@FindBy(xpath = "//a[text()='Create Children Interview']")
	...
	//Mrunal
	@FindBy(xpath="//*[text()='Decision Making Tool']/../../..//a[contains(@title,'A-')]")
	...
	public void openFirstRecord() throws AcisException {
		...
		waitForPageLoadTill(9);
		clickWebElemntUsingJavascriptExecutor(assessmentRelated);
	...
	public void reviewingInformation() throws AcisException, IOException  {
		{
