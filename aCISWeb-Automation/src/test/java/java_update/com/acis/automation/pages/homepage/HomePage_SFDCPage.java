...
public class HomePage_SFDCPage extends PageBase {
	...
	@FindBy(xpath = "//span[@class='menuLabel slds-listbox__option-text slds-listbox__option-text_entity' and text()='Child Welfare Cases']")
	WebElement downArrowCaseAction;
	
	@FindBy(xpath = "//span[@class='menuLabel slds-listbox__option-text slds-listbox__option-text_entity' and text()='Households']")
	...
	@FindBy(xpath="//a[contains(text(),'C-0000')]")
	WebElement investigationCaseId;
	...
	WebElement Investigationrecord;
	
	@FindBy(xpath = "//span[@class='menuLabel slds-listbox__option-text slds-listbox__option-text_entity' and text()='Case Plans']")
	WebElement downArrowCasePlan;
	
	@FindBy(xpath = "//span[text()='Case Plans - Supervisor Queue']")
	WebElement CPSupervisorQueue;
	
	@FindBy(xpath = "//div[text()='New']")
	WebElement newProspectiveFoterParent;
	
	@FindBy(xpath = "//span[text()='Selected']/../..//span[text()='My Child Welfare Cases to Review']")
	WebElement myChildWelfareCasesReview;
	
	@FindBy(xpath = "//span[text()='Case Head']")
	WebElement caseHead;
	
	@FindBy(xpath = "//span[text()='Child Welfare Case ID']")
	WebElement childWelfareCaseId;
	...
	@FindBy(xpath = "//span[text()='Child Welfare Supervisor Home Page Dashboard']")
	WebElement homeDashboard;
	
	@FindBy(xpath = "//div[text()='My Assessments to Review']")
	WebElement assessmentReview;
	
	@FindBy(xpath = "//a[@class='truncation enabledLink' and text()='View Report (My Assessments to Review)']")
	WebElement viewAssessmentReview;
	
	@FindBy(xpath = "//button[@class='slds-button slds-button_icon-border-filled ignore-click-table6-3'][contains(.,'Column Actions')]")
	WebElement dateSubmittedAssessmentReview;
	
	@FindBy(xpath = "//span[text()='Sort Descending']")
	WebElement sortDescending;
	@FindBy(xpath = "(//span[text()='Date Submitted'])[2]")
	WebElement dateSubmitted;
	@FindBy(xpath = "//iframe[@title='dashboard']")
	WebElement dashboard;
	
	@FindBy(xpath = "//iframe[@title='Report Viewer']")
	WebElement myAssessmentReview;
	
	@FindBy(xpath="//span[contains(text(),'\"')]")
	WebElement dobRecord;
	

	@FindBy(xpath="//span[@class='menuLabel slds-listbox__option-text slds-listbox__option-text_entity' and text()='Dashboards']")
	WebElement downDashboards;
	
	public By sortedDescending = By.xpath("(//span[text()='Date Submitted'])[2]/..//div[@class='slds-tooltip-trigger']");
	 ...
	 * @throws InterruptedException 
	 */
	public void searchGlobalforInvestigation(String strText) throws AcisException, InterruptedException {
		logger.info("Clicking on Global Search");
		waitForElement(downArrow);
		waitForElementClickable(globalSearchDropdown);
		clickWebElement(globalSearchDropdown);
		...
		logger.info("Clicking on case Id after entering ");
		clickWebElemntUsingJavascriptExecutor(investigationCaseId);
		waitForPageLoadTill(9);
		logger.info("Clicked on Investigation Record on Global Search");
		refreshPage();
		waitForPageLoadTill(10);
		waitForPageLoad();
		logger.info("Global Search for Investigation Record");
	 ...
	 * @throws AcisException 
	 */
	public void searchInvestigationAndClick(String recordName) throws AcisException {
		logger.info("Searching the record on internal search box : " + recordName);
		waitForPageLoad();
		waitForPageLoadTill(5);
		enterText(searchBox, recordName);
		...
		waitForPageLoadTill(5);
		logger.info("Searched the record on internal search box : " + recordName);
		clickWebElement(Investigationrecord);
		waitForPageLoadTill(10);
		waitForPageLoad();
		logger.info(" clicked  on record" + recordName);
	...
	/**
	 * Click on DownArrow and Click on Case Plan
	 * Created By Pallavi
	 * @throws AcisException 
	 * @throws InterruptedException 
	 */
	public void ClickDownArrowCasePlan() throws AcisException {
		logger.info("Clicking on DownArrow");
		waitForElementClickable(downArrow);
		clickWebElement(downArrow);
		logger.info("Clicked on DownArrow");
		waitForPageLoadTill(10);
		logger.info("Clicking on Allegation from DownArrow");
		waitForElementClickable(downArrowCasePlan);
		clickWebElement(downArrowCasePlan);
		waitForPageLoadTill(5);
	}
	
	/**
	 * Select : Case Plan- Supervisor Queue from Select List View
	 * Created By Pallavi
	 * @throws AcisException 
	 * @throws InterruptedException 
	 */
	public void selectAllCasePlanSupervisorQueue() throws AcisException, InterruptedException {
		logger.info("Clicking on ListView");
		waitForPageLoadTill(10);
		waitForPageLoad();
		waitForElementClickable(listView);
		...
		waitForPageLoadTill(5);
		logger.info("Selecting All Allegation from Select List View");
		waitForElementClickable(CPSupervisorQueue);
		clickWebElement(CPSupervisorQueue);
		waitForPageLoadTill(5);
		waitForPageLoad();
		logger.info("Selected All Allegation from Select List View");
	}
	
	/*Clicking on New Prospective foster PArent
	 * Created By Pallavi
	 */
	public void ClickNewProspective() throws AcisException {
		logger.info("Clicking on New Prospective foster PArent");
		waitForPageLoad();
		waitForPageLoadTill(5);
		waitForElement(newProspectiveFoterParent);
		clickWebElement(newProspectiveFoterParent);
		waitForPageLoadTill(8);
		logger.info("Clicked on New Prospective foster PArent");
	}
	
	/**
	 * Select : My Child Welfare Cases to Review
	 * Created By Pallavi
	 * @throws AcisException 
	 * @throws InterruptedException 
	 */
	public void selectMyChildWefareCasesToReview() throws AcisException, InterruptedException {
		logger.info("Clicking on ListView");
		waitForPageLoadTill(10);
		waitForPageLoad();
		waitForElementClickable(listView);
		...
		logger.info("Clicked on ListView");
		waitForPageLoadTill(5);
		logger.info("Selecting My Child Welfare Cases to Review from Select List View");
		waitForElementClickable(myChildWelfareCasesReview);
		clickWebElemntUsingJavascriptExecutor(myChildWelfareCasesReview);
		waitForPageLoadTill(5);
		waitForPageLoad();
		logger.info("Selected My Child Welfare Cases to Review from Select List View");
	}
	
	/***Verify Child Welfare Cases To Review : Case Head , Child Welfare Case Id, Case Type and Status
	 * @author pallavi
	 */
	public void CasesToReview() {
		logger.info("Verifying List View Fields");
		waitForPageLoad();
		waitForPageLoadTill(5);
		waitForElement(caseHead);
		Assert.assertTrue(caseHead.isDisplayed(), "Error : Child welfare case Case Head is Not present");
		waitForElement(childWelfareCaseId);
		Assert.assertTrue(childWelfareCaseId.isDisplayed(), "Error : Child welfare case Case ID is Not present");
		waitForElement(caseType);
		Assert.assertTrue(caseType.isDisplayed(), "Error : Child welfare case Case Type is Not present");
		waitForElement(status);
		Assert.assertTrue(status.isDisplayed(), "Error : Child welfare case Status is Not present");
		waitForPageLoadTill(5);
		logger.info("Verified List View Fields");
	}
	
	/*** Clicking On My assessment Review
	 * @author pallavi.sanjay.yemle
	 * @throws AcisException 
	 */
	public void clickOnMyAssessmentReview() throws AcisException {
		logger.info("Clicking On My assessment Review");
		waitForPageLoad();
		waitForPageLoadTill(10);
		switchToFrameByWebElement(dashboard);
		waitForElement(homeDashboard);
		waitForElement(assessmentReview);
		scrollingToElementofAPage(assessmentReview);
		waitForElementClickable(viewAssessmentReview);
		clickWebElement(viewAssessmentReview);
		waitForPageLoad();
		waitForPageLoadTill(5);
		logger.info("Clicking On My assessment Review");
	}
	...
	/**
	 *  Search Enter and click on the record
	 * Created By Pallavi
	 * @throws AcisException 
	 * @throws InterruptedException 
	 */
	public void searchDecisionMakingTool(String strText) throws AcisException, InterruptedException {
		logger.info("Clicking on Date submited assessment review");
		waitForPageLoad();
		waitForPageLoadTill(5);
		refreshPage();
		waitForPageLoad();
		...
		switchToFrameByWebElement(myAssessmentReview);
		waitForElement(dateSubmitted);
		clickWebElemntUsingJavascriptExecutor(dateSubmitted);
		waitForPageLoadTill(3);
		clickWebElemntUsingJavascriptExecutor(dateSubmitted);
		waitForElement(dateSubmitted);
		waitForPageLoadTill(10);
		logger.info("Clicking On Decision Assessment");
		waitForElement(driver.findElement(By.xpath("//a[contains(text(),'"+strText+"')]")));
		clickWebElement(driver.findElement(By.xpath("//a[contains(text(),'"+strText+"')]")));
		waitForPageLoadTill(5);
		logger.info("Clicked on Decision Assessment");
		waitForPageLoadTill(6);
		refreshPage();
		waitForPageLoadTill(10);
		waitForPageLoad();
	 ...
	 * @throws AcisException 
	 */
	public void clickDashboards() throws AcisException {
		logger.info("Clicking on Dashboards");
		waitForElementClickable(downArrow);
		clickWebElement(downArrow);
		logger.info("Clicked on Dashboards");
		waitForPageLoadTill(5);
		logger.info("Clicking on Dashboards from DownArrow");
		waitForElementClickable(downArrow);
		clickWebElement(downDashboards);
		waitForPageLoadTill(5);
		waitForPageLoad();
		logger.info("Clicked on Account from Dashboards");

	}

	/**
	 * Global Search Enter DOB  and click on the record
	 * Created By khushboo
	 * @throws AcisException 
	 * @throws InterruptedException 
	 */
	public void searchGlobalDOB(String strText) throws AcisException, InterruptedException {
		logger.info("Clicking on Global Search");
		waitForElement(downArrow);
		waitForElementClickable(globalSearchDropdown);
		clickWebElement(globalSearchDropdown);
		...
		globalSearchAllegation.sendKeys(strText);
		waitForPageLoadTill(5);
		waitForElement(dobRecord);
		clickWebElement(dobRecord);
		logger.info("Clicked on Allegation Record on Global Search");
		waitForPageLoadTill(6);
		refreshPage();
		waitForPageLoadTill(10);
