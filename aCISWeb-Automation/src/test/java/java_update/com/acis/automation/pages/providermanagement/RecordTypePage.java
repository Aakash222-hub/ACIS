...
public class RecordTypePage extends PageBase {
	...
	@FindBy(xpath="//*[text()='Close New Child Welfare Case']/../..//lightning-primitive-icon")
	WebElement closeNewAction;
	...
	@FindBy(xpath="//label[text()='Visit']")
	WebElement visitLabel;
	
	@FindBy(xpath="//label[text()='Collateral']")
	WebElement collateralLabel;
	
	@FindBy(xpath="//label[text()='Meeting']")
	WebElement meetingLabel;
	
	@FindBy(xpath="//label[text()='TDM']")
	WebElement tdmLabel;
	...
	waitForPageLoadTill(9);
	clickWebElement(closeNewAction);
	logger.info("Closed new action label");
	}
